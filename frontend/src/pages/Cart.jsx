      ...
      const order = await api('/orders', {
        ...
        body: JSON.stringify({
          ...
          checkout: {
            ...
            deliveryMethod: selectedDelivery.kind === 'pickup' ? 'pickup' : 'shipping',
