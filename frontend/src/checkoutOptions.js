...
export const deliveryNames = {
  ...
  ukrposhta_branch: { pl: 'Oddział Ukrposhty', uk: 'Відділення Укрпошти', en: 'Ukrposhta branch' },
  ukrposhta_courier: { pl: 'Kurier Ukrposhty', uk: 'Кур’єр Укрпошти', en: 'Ukrposhta courier' },
